...
export const DRUGS: DrugInput[] = [
  {
    ...
    unit: "mg",
    placeholder: "Hydromorphone Oral (mg)",
  },
  {
    id: "hydromorphone_iv",
    label: "Hydromorphone IV",
    unit: "mg",
    placeholder: "Hydromorphone IV (mg)",
  },
  {
    id: "morphine_oral",
    label: "Morphine - Oral",
    unit: "mg",
    placeholder: "Morphine Oral (mg)",
  },
  {
    id: "methadone",
    label: "Methadone",
    unit: "mg",
    placeholder: "Methadone (mg)",
  },
  {
    id: "fentanyl_transdermal",
    label: "Fentanyl - Transdermal",
    unit: "mcg/hr",
    placeholder: "Fentanyl Transdermal (mcg/hr)",
  },
  {
    id: "oxycodone_oral",
    label: "Oxycodone - Oral",
    unit: "mg",
    placeholder: "Oxycodone Oral (mg)",
  },
  {
    id: "sufentanil",
    label: "Sufentanil - IV/SC",
    unit: "mcg",
    placeholder: "Sufentanil IV/SC (mcg)",
  },
];
